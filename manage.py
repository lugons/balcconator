...
def initdb():
    ...
    ev3 = Event('jane', 'Jane 101', 'Foreword by Jane', datetime(2013, 9, 2, 13, 0), datetime(2013, 9, 1, 13, 59), 2)
    ev4 = Event('john', 'John 102', 'Continuation by John', datetime(2013, 9, 2, 14, 0), datetime(2013, 9, 1, 14, 59), 1)
    db.session.add(ev2)
    db.session.add(ev3)
    db.session.add(ev4)
    db.session.commit()
